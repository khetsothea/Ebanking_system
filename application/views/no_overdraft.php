...
<link href=<?php echo base_url()."css/fonts.css"; ?> rel="stylesheet" type="text/css" media="all" />
    ...
    <h2 align="center"><span class="icon icon-lock icon-size"></span>
        ...
        Uneti iznos uplate je veći od raspoloživih sredstava na Vašem računu. Pokušajte sa manjim iznosom. <br />
      </h2>
            <p align="center"> <a href=<?php echo base_url()."Client"; ?> class="button">Vrati transakciju</a></p>
</div>