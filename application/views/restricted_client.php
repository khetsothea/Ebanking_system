...
<link href=<?php echo base_url()."css/fonts.css"; ?> rel="stylesheet" type="text/css" media="all" />
    ...
    <h2 align="center"><span class="icon icon-lock icon-size"></span>
        ...
        unesite ispravne podatke korisnika da bi ste pristupili ovoj stranici <br />
      </h2>
            <p align="center"> <a href=<?php echo base_url()."Home"; ?> class="button">Prijavi klijenta</a></p>
</div>